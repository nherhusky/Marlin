...
#define STRING_CONFIG_H_AUTHOR "(Nick, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bender-3"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -6, -3.4 }
